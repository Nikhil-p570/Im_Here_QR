          ...
          <div className="setup-panel">
            ...
            {!uploadedImg ? (
              ...
              <>
                ...
                {/* Version Selection */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '20px', textAlign: 'left', width: '100%' }}>
                  <label style={{ fontWeight: 700, fontSize: '0.9rem', color: 'var(--text-primary)' }}>Select Tag Style Version:</label>
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    >
                      <div style={{ fontWeight: 700, fontSize: '0.85rem', marginBottom: '2px' }}>Version 1 (Original)</div>
                      <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary)' }}>Front: QR on custom photo<br />Back: Full logo cover</div>
                    </button>
                    <button
                    ...
                    >
                      <div style={{ fontWeight: 700, fontSize: '0.85rem', marginBottom: '2px' }}>Version 2 (New Layout)</div>
                      <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary)' }}>Front: QR on logo icon<br />Back: Custom photo cover</div>
                    </button>
                  </div>
                </div>
